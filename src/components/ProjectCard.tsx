  ...
  return (
    <Card span={3} gap="medium">
      ...
      <div className="grid grid-cols-2 gap-4 md:grid-cols-3 md:gap-4 mt-auto">
        ...
        <Card variant="tile" className="flex flex-col gap-4 cursor-pointer hover:border-white/30 hover:bg-white/[0.05]">
          ...
          <div className="flex-1 flex flex-col justify-start text-left gap-3">
            ...
            <div className="hidden md:flex flex-wrap gap-x-4 gap-y-2 mt-auto pt-2">
              ...
              >
                <span className="text-xs font-bold text-brand-high group-hover/link:text-white">
                  GitHub 코드 보기 →
                </span>
              </a>
              <a
                ...
                className="flex items-center gap-x-1.5 group/link w-fit"
              >
                <span className="text-xs font-bold text-brand-mid group-hover/link:text-white">
                  기존 사이트 보기 →
                </span>
              </a>
            </div>
